...
const fromCandidate = candidate
  ? spawnSync("git", ["-C", candidate, "rev-parse", "--show-toplevel"], { encoding: "utf8" })
  : null;
const fromCwd = spawnSync("git", ["rev-parse", "--show-toplevel"], { cwd, encoding: "utf8" });
const root = fromCandidate && !fromCandidate.error && fromCandidate.status === 0
