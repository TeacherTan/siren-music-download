...
- `LibrarySearchHitField = 'title' | 'artist' | 'intro' | 'belong'`
- `LibraryIndexState = 'notReady' | 'building' | 'stale' | 'ready'`
...
- `matchedFields` 可以扩展为 `title | artist | intro | belong`，但不暴露底层拼音 / tokenizer / score 细节
